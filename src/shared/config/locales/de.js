...
export const baseDE = {
  marcus: {
    ...
    heroTitle: {
       part1: 'IHR ERSTER',
       part2: 'HOCHEINKOMMENS-STREAM.',
       part3: '7 TAGE.'
    },
    heroSubtitle: 'DIE 7-TAGE-CHALLENGE ZU IHREM ERSTEN DIGITALEN EINKOMMEN — VON GRUND AUF NEU',
    heroStatsJoined: '1.031 UNTERNEHMER HABEN DIESEN MONAT BEGONNEN',
    heroStatsHighPerformers: '992 HIGH-PERFORMER HABEN DIESEN MONAT BEGONNEN',
    heroBullets: [
